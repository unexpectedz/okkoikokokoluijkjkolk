...
ProtectGui(ScreenGui);local InputService = game:GetService('UserInputService');
local TextService = game:GetService('TextService');
local CoreGui = game:GetService('CoreGui');
local Teams = game:GetService('Teams');
local Players = game:GetService('Players');
...
print("frameStartPos:", frameStartPos.X, frameStartPos.Y)
print("Instance AbsPos BEFORE set:", Instance.AbsolutePosition.X, Instance.AbsolutePosition.Y)
print("Instance Position BEFORE set:", Instance.Position.X.Offset, Instance.Position.Y.Offset)
print("Ghost pos:", Ghost.Position.X.Offset, Ghost.Position.Y.Offset)
print("Inset:", GuiService:GetGuiInset())
print("Parent:", Instance.Parent.Name, Instance.Parent.AbsolutePosition.X, Instance.Parent.AbsolutePosition.Y)
            dragging = false
            Ghost.Visible = false
